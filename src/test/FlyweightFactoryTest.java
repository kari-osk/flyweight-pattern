...
public class FlyweightFactoryTest {
    ...
    void getTrianguloComTamanho2() {
        ...
        @Test
        void getQuadradoComTamanho() {
        Quadrado quadrado = FlyweightFactory.obterQuadrado(3);
        quadrado.setCor("azul");

        Quadrado quadrado1 = FlyweightFactory.obterQuadrado(4);
        quadrado1.setCor("vermelho");

        Quadrado quadrado2 = FlyweightFactory.obterQuadrado(3);
        quadrado2.setCor("vermelho");

        assertEquals(quadrado.getTamanho(),3);

        assertEquals(quadrado1.getCor(),"vermelho");

        assertEquals(FlyweightFactory.quadradoMap.size() == 3, false);
